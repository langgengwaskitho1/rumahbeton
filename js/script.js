(function($) {
    ...
    //     var myLatLng = new google.maps.LatLng(-6.3364256,106.939145);
    //     var mapProp = {
    //         center: myLatLng,
    //         zoom: 20,
    //         scrollwheel: false,
    ...
    var switcherHtml = '<div class="style-switcher-box"> <div class="switcher-inner"><h5>Merubah Style</h5> <div class="main-list"> <div class="list"> <span class="list-title">Skin color</span> <div class="sublist"> <ul class="color-chager"> <li class="color-default"><img src="images/switcher-color/img-1.jpg" alt></li> <li class="color-style1"><img src="images/switcher-color/img-2.jpg" alt></li> <li class="color-style2"><img src="images/switcher-color/img-3.jpg" alt></li> <li class="color-style3"><img src="images/switcher-color/img-4.jpg" alt></li> </ul> </div> </div> <div class="list layout"> <span class="list-title">Layout</span> <div class="sublist"> <ul class="layout-sw"> <li>Full width</li> <li class="box">Box</li> </ul> </div> </div> </div> <p><span></span> </p> </div> <button class="toggle-btn"><i class="fa fa-cog"></i></button> </div>';
